...
{
  {
    GNOME_APP_UI_ITEM, N_("toggle fullscreen"),
    NULL,
    (gpointer) on_toggle_fullscreen1_activate, NULL, NULL,
    GNOME_APP_PIXMAP_NONE, NULL,
    GDK_F, (GdkModifierType) GDK_CONTROL_MASK, NULL
  },
  {
    GNOME_APP_UI_TOGGLEITEM, N_("toggle desktop-view"),
    N_("maximizes mainwindow and hides window-decorations"),
    (gpointer) on_toggle_desktop_view1_activate, NULL, NULL,
    GNOME_APP_PIXMAP_NONE, NULL,
...
create_MainWindow (void)
{
  ...
  GtkWidget *toolbar4;
  GtkWidget *frame1movebutton1;
  GtkWidget *frame1movebutton2;
  GtkWidget *frame1nb;
  ...
  GtkWidget *viewport1;
  GtkWidget *image;
  GtkWidget *multipagebox;
  GtkWidget *scrolledwindowmp;
  GtkWidget *iconlistmp;
  GtkWidget *progressbarmp;
  GtkWidget *label29;
  ...
  MainWindow = gnome_app_new ("Look at the stars", _("Look at the stars"));
  ...
  gtk_object_set_data_full (GTK_OBJECT (MainWindow), "save_as1",
                            ...
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_set_sensitive (file1_menu_uiinfo[3].widget, FALSE);
  ...
  gtk_object_set_data_full (GTK_OBJECT (MainWindow), "properties1",
                            ...
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_set_sensitive (edit1_menu_uiinfo[5].widget, FALSE);
  ...
  gtk_object_set_data_full (GTK_OBJECT (MainWindow), "toggle_fullscreen1",
                            view1_menu_uiinfo[0].widget,
                            (GtkDestroyNotify) gtk_widget_unref);

  gtk_widget_ref (view1_menu_uiinfo[1].widget);
  gtk_object_set_data_full (GTK_OBJECT (MainWindow), "toggle_desktop_view1",
  ...
  button9 = gtk_toolbar_append_element (GTK_TOOLBAR (toolbar2),
                                GTK_TOOLBAR_CHILD_BUTTON,
                                NULL,
                                _("Recreate thumbnails"),
                                _("Recreate thumbnails in current directory"), NULL,
                                tmp_toolbar_icon, NULL, NULL);
  ...
  gtk_clist_set_column_width (GTK_CLIST (dirlist), 0, 146);
  gtk_clist_set_column_width (GTK_CLIST (dirlist), 1, 80);
  gtk_clist_column_titles_hide (GTK_CLIST (dirlist));

  label48 = gtk_label_new (_("directory"));
  gtk_widget_ref (label48);
  gtk_object_set_data_full (GTK_OBJECT (MainWindow), "label48", label48,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label48);
  gtk_clist_set_column_widget (GTK_CLIST (dirlist), 0, label48);
  gtk_label_set_justify (GTK_LABEL (label48), GTK_JUSTIFY_LEFT);

  label49 = gtk_label_new (_("usable content"));
  gtk_widget_ref (label49);
  gtk_object_set_data_full (GTK_OBJECT (MainWindow), "label49", label49,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label49);
  gtk_clist_set_column_widget (GTK_CLIST (dirlist), 1, label49);
  ...
  gtk_box_pack_start (GTK_BOX (frame1), hbox11, FALSE, TRUE, 0);
  gtk_container_set_border_width (GTK_CONTAINER (hbox11), 5);

  frame1radiobutton1 = gtk_radio_button_new_with_label (showasbuttons_group, _("details"));
  ...
  gtk_box_pack_start (GTK_BOX (hbox11), frame1radiobutton1, TRUE, TRUE, 0);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (frame1radiobutton1), TRUE);

  frame1radiobutton2 = gtk_radio_button_new_with_label (showasbuttons_group, _("images"));
  ...
  gtk_box_pack_start (GTK_BOX (hbox11), frame1radiobutton2, TRUE, TRUE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (hbox11), toolbar4, FALSE, TRUE, 0);

  tmp_toolbar_icon = gnome_stock_pixmap_widget (MainWindow, GNOME_STOCK_PIXMAP_UP);
  frame1movebutton1 = gtk_toolbar_append_element (GTK_TOOLBAR (toolbar4),
                                GTK_TOOLBAR_CHILD_BUTTON,
                                NULL,
                                "",
                                _("enlarge icon list"), NULL,
                                tmp_toolbar_icon, NULL, NULL);
  gtk_widget_ref (frame1movebutton1);
  gtk_object_set_data_full (GTK_OBJECT (MainWindow), "frame1movebutton1", frame1movebutton1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (frame1movebutton1);

  tmp_toolbar_icon = gnome_stock_pixmap_widget (MainWindow, GNOME_STOCK_PIXMAP_DOWN);
  frame1movebutton2 = gtk_toolbar_append_element (GTK_TOOLBAR (toolbar4),
                                GTK_TOOLBAR_CHILD_BUTTON,
                                NULL,
                                "",
                                _("enlarge directory list"), NULL,
                                tmp_toolbar_icon, NULL, NULL);
  gtk_widget_ref (frame1movebutton2);
  gtk_object_set_data_full (GTK_OBJECT (MainWindow), "frame1movebutton2", frame1movebutton2,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (frame1movebutton2);
  ...
  gtk_clist_column_titles_hide (GTK_CLIST (imagelist));
  ...
  iconlist1 = gnome_icon_list_new_flags (100, NULL, 0);
  ...
  gtk_tooltips_set_tip (tooltips, iconlist1, _("use left mousebutton to select; use middle mousebutton to view in fullscreen-mode"), NULL);
  ...
  gtk_box_pack_start (GTK_BOX (bgcolorbox), bgcoloruse, FALSE, FALSE, 2);
  GTK_WIDGET_UNSET_FLAGS (bgcoloruse, GTK_CAN_FOCUS);
  gtk_tooltips_set_tip (tooltips, bgcoloruse, _("use defined color?"), NULL);
  ...
  gtk_box_pack_start (GTK_BOX (bgcolorbox), toolbar5, TRUE, TRUE, 0);
  ...
  zoomentry = gtk_spin_button_new (GTK_ADJUSTMENT (zoomentry_adj), 1, 5);
  ...
  gtk_object_set_data_full (GTK_OBJECT (MainWindow), "table11", table11,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (table11);
  gtk_box_pack_start (GTK_BOX (imagedisplay_old), table11, TRUE, TRUE, 0);
  ...
  gtk_table_attach (GTK_TABLE (table11), scrolledwindow6, 0, 1, 0, 1,
  ...
  gtk_widget_set_events (viewport1, GDK_POINTER_MOTION_MASK | GDK_BUTTON1_MOTION_MASK | GDK_BUTTON_PRESS_MASK | GDK_BUTTON_RELEASE_MASK);
  gtk_widget_set_extension_events (viewport1, GDK_EXTENSION_EVENTS_ALL);
  ...
  multipagebox = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (multipagebox);
  gtk_object_set_data_full (GTK_OBJECT (MainWindow), "multipagebox", multipagebox,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (multipagebox);
  gtk_table_attach (GTK_TABLE (table11), multipagebox, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_SHRINK | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL), 0, 0);
  gtk_widget_set_usize (multipagebox, 100, -2);

  scrolledwindowmp = gtk_scrolled_window_new (NULL, NULL);
  gtk_widget_ref (scrolledwindowmp);
  gtk_object_set_data_full (GTK_OBJECT (MainWindow), "scrolledwindowmp", scrolledwindowmp,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (scrolledwindowmp);
  gtk_box_pack_start (GTK_BOX (multipagebox), scrolledwindowmp, TRUE, TRUE, 0);
  gtk_scrolled_window_set_policy (GTK_SCROLLED_WINDOW (scrolledwindowmp), GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);

  iconlistmp = gnome_icon_list_new_flags (100, NULL, 0);
  gtk_widget_ref (iconlistmp);
  gtk_object_set_data_full (GTK_OBJECT (MainWindow), "iconlistmp", iconlistmp,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (iconlistmp);
  gtk_container_add (GTK_CONTAINER (scrolledwindowmp), iconlistmp);
  GTK_WIDGET_SET_FLAGS (iconlistmp, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, iconlistmp, _("click on a thumbnail to a view page"), NULL);
  gnome_icon_list_set_row_spacing (GNOME_ICON_LIST (iconlistmp), 10);
  gnome_icon_list_set_col_spacing (GNOME_ICON_LIST (iconlistmp), 5);

  progressbarmp = gtk_progress_bar_new ();
  gtk_widget_ref (progressbarmp);
  gtk_object_set_data_full (GTK_OBJECT (MainWindow), "progressbarmp", progressbarmp,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_box_pack_start (GTK_BOX (multipagebox), progressbarmp, FALSE, TRUE, 0);
  gtk_progress_bar_set_bar_style (GTK_PROGRESS_BAR (progressbarmp), GTK_PROGRESS_DISCRETE);
  gtk_progress_set_activity_mode (GTK_PROGRESS (progressbarmp), TRUE);
  ...
  iconlist = gnome_icon_list_new_flags (100, NULL, 0);
  ...
  gtk_tooltips_set_tip (tooltips, iconlist, _("use left mousebutton to select; use middle mousebutton to view in fullscreen-mode"), NULL);
  ...
  gtk_progress_set_format_string (GTK_PROGRESS (progressbar1), _("file %V of %U"));

  imageprogressbar = gtk_progress_bar_new ();
  gtk_widget_ref (imageprogressbar);
  gtk_object_set_data_full (GTK_OBJECT (MainWindow), "imageprogressbar", imageprogressbar,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_box_pack_start (GTK_BOX (appbarbox), imageprogressbar, FALSE, TRUE, 0);
  gtk_progress_configure (GTK_PROGRESS (imageprogressbar), 1, 1, 100);
  gtk_progress_set_show_text (GTK_PROGRESS (imageprogressbar), TRUE);
  gtk_progress_set_format_string (GTK_PROGRESS (imageprogressbar), _("page %V of %U"));
  ...
  gtk_signal_connect (GTK_OBJECT (frame1radiobutton2), "toggled",
                      ...
                      NULL);
  gtk_signal_connect (GTK_OBJECT (frame1movebutton1), "clicked",
                      GTK_SIGNAL_FUNC (on_frame1movebutton1_clicked),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (frame1movebutton2), "clicked",
                      GTK_SIGNAL_FUNC (on_frame1movebutton2_clicked),
                      NULL);
  ...
  gtk_signal_connect (GTK_OBJECT (scrolledwindow6), "button_press_event",
                      ...
                      NULL);
  gtk_signal_connect (GTK_OBJECT (scrolledwindow6), "button_release_event",
                      GTK_SIGNAL_FUNC (on_scrolledwindow6_button_release_event),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (scrolledwindow6), "motion_notify_event",
                      GTK_SIGNAL_FUNC (on_scrolledwindow6_motion_notify_event),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (iconlistmp), "select_icon",
                      GTK_SIGNAL_FUNC (on_iconlist2_select_icon),
                      MainWindow);
...
create_about1 (void)
{
  ...
  about1 = gnome_about_new ("Look at the stars", VERSION,
                        "",
                        authors,
                        _("What you see here is my first try in writing a more or less complex picture-viewer. You can view your icons or images with different backgroundcolors, too. So testing out icons against different environments should be easier now :) If you find any bugs or suggestions for me doing a better job - tell me ! :) Thnx."),
                        "lats/look_at_the_stars_icon.png");
...
create_prefswindow (void)
{
  ...
  GtkWidget *vbox18;
  GSList *imagedpi_group = NULL;
  GtkWidget *prefsimageradiobutton5;
  GtkWidget *prefsimageradiobutton6;
  GtkWidget *hbox14;
  GtkWidget *hbox15;
  GtkWidget *label51;
  GtkObject *prefsimagedpispinbuttonx_adj;
  GtkWidget *prefsimagedpispinbuttonx;
  GtkWidget *label52;
  GtkObject *prefsimagedpispinbuttony_adj;
  GtkWidget *prefsimagedpispinbuttony;
  GtkWidget *label53;
  GtkWidget *prefsimagecalibratebutton;
  GtkWidget *prefsimageframe4;
  GtkWidget *table7;
  GtkWidget *label39;
  ...
  GtkWidget *hbox12;
  GtkWidget *label40;
  GtkWidget *prefsthumbentry3;
  GtkWidget *prefsthumbupdatebutton;
  GtkWidget *prefsthumbclearbutton;
  GtkWidget *frame6;
  GtkWidget *vbox14;
  ...
  GtkWidget *label43;
  GtkWidget *label44;
  GtkWidget *prefsfiltercheckbutton2;
  GtkWidget *prefsfiltercheckbutton3;
  GtkWidget *prefsfiltercheckbutton4;
  GtkWidget *prefsfiltercheckbutton5;
  GtkWidget *prefsfiltercheckbutton6;
  GtkWidget *table10;
  GtkWidget *prefsfiltercheckbutton1;
  GtkWidget *label42;
  GtkWidget *prefslabel4;
  ...
  gtk_notebook_set_tab_hborder (GTK_NOTEBOOK (prefsmainnotebook), 40);
  ...
  gtk_widget_set_sensitive (prefsmainreset, FALSE);
  ...
  prefsmaintogglebutton1 = gtk_check_button_new_with_label (_(" yes, please do this !"));
  ...
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "vbox16", vbox16,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_box_pack_start (GTK_BOX (vbox16), prefsimageframe1, FALSE, TRUE, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "hseparator8", hseparator8,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hseparator8);
  gtk_box_pack_start (GTK_BOX (vbox9), hseparator8, TRUE, TRUE, 10);

  hbox13 = gtk_hbox_new (FALSE, 0);
  gtk_widget_ref (hbox13);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "hbox13", hbox13,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hbox13);
  gtk_box_pack_start (GTK_BOX (vbox9), hbox13, TRUE, TRUE, 0);

  label50 = gtk_label_new (_("what DPI ( dots per inches ) do you prefer when rendering\n.pdf ( Adobe Acrobat Reader ) or .ps ( PostScript ) files?\n( 72 = poor, fast ; 150 = normal ; 300 = fine, slow )"));
  gtk_widget_ref (label50);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "label50", label50,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label50);
  gtk_box_pack_start (GTK_BOX (hbox13), label50, FALSE, TRUE, 0);
  gtk_label_set_justify (GTK_LABEL (label50), GTK_JUSTIFY_LEFT);

  spinbutton9_adj = gtk_adjustment_new (150, 1, 1440, 1, 10, 10);
  spinbutton9 = gtk_spin_button_new (GTK_ADJUSTMENT (spinbutton9_adj), 1, 0);
  gtk_widget_ref (spinbutton9);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "spinbutton9", spinbutton9,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (spinbutton9);
  gtk_box_pack_start (GTK_BOX (hbox13), spinbutton9, TRUE, FALSE, 0);
  gtk_spin_button_set_numeric (GTK_SPIN_BUTTON (spinbutton9), TRUE);

  hseparator9 = gtk_hseparator_new ();
  gtk_widget_ref (hseparator9);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "hseparator9", hseparator9,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hseparator9);
  gtk_box_pack_start (GTK_BOX (vbox9), hseparator9, TRUE, TRUE, 10);

  vbox18 = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (vbox18);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "vbox18", vbox18,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox18);
  gtk_box_pack_start (GTK_BOX (vbox9), vbox18, FALSE, FALSE, 0);

  prefsimageradiobutton5 = gtk_radio_button_new_with_label (imagedpi_group, _("get DPI for displaying images from x-server"));
  imagedpi_group = gtk_radio_button_group (GTK_RADIO_BUTTON (prefsimageradiobutton5));
  gtk_widget_ref (prefsimageradiobutton5);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "prefsimageradiobutton5", prefsimageradiobutton5,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (prefsimageradiobutton5);
  gtk_box_pack_start (GTK_BOX (vbox18), prefsimageradiobutton5, FALSE, FALSE, 0);

  prefsimageradiobutton6 = gtk_radio_button_new_with_label (imagedpi_group, _("use your own values for displaying images"));
  imagedpi_group = gtk_radio_button_group (GTK_RADIO_BUTTON (prefsimageradiobutton6));
  gtk_widget_ref (prefsimageradiobutton6);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "prefsimageradiobutton6", prefsimageradiobutton6,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (prefsimageradiobutton6);
  gtk_box_pack_start (GTK_BOX (vbox18), prefsimageradiobutton6, FALSE, FALSE, 0);

  hbox14 = gtk_hbox_new (FALSE, 0);
  gtk_widget_ref (hbox14);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "hbox14", hbox14,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "hbox15", hbox15,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hbox15);
  gtk_box_pack_start (GTK_BOX (hbox14), hbox15, TRUE, TRUE, 0);

  label51 = gtk_label_new (_("your values for width and height:"));
  gtk_widget_ref (label51);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "label51", label51,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label51);
  gtk_box_pack_start (GTK_BOX (hbox15), label51, TRUE, TRUE, 0);

  prefsimagedpispinbuttonx_adj = gtk_adjustment_new (91.44, 1, 300, 1, 10, 10);
  prefsimagedpispinbuttonx = gtk_spin_button_new (GTK_ADJUSTMENT (prefsimagedpispinbuttonx_adj), 1, 3);
  gtk_widget_ref (prefsimagedpispinbuttonx);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "prefsimagedpispinbuttonx", prefsimagedpispinbuttonx,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (prefsimagedpispinbuttonx);
  gtk_box_pack_start (GTK_BOX (hbox15), prefsimagedpispinbuttonx, TRUE, TRUE, 0);
  gtk_spin_button_set_numeric (GTK_SPIN_BUTTON (prefsimagedpispinbuttonx), TRUE);

  label52 = gtk_label_new (_("x"));
  gtk_widget_ref (label52);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "label52", label52,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label52);
  gtk_box_pack_start (GTK_BOX (hbox15), label52, FALSE, FALSE, 0);

  prefsimagedpispinbuttony_adj = gtk_adjustment_new (91.649, 1, 300, 1, 10, 10);
  prefsimagedpispinbuttony = gtk_spin_button_new (GTK_ADJUSTMENT (prefsimagedpispinbuttony_adj), 1, 3);
  gtk_widget_ref (prefsimagedpispinbuttony);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "prefsimagedpispinbuttony", prefsimagedpispinbuttony,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (prefsimagedpispinbuttony);
  gtk_box_pack_start (GTK_BOX (hbox15), prefsimagedpispinbuttony, TRUE, TRUE, 0);
  gtk_spin_button_set_numeric (GTK_SPIN_BUTTON (prefsimagedpispinbuttony), TRUE);

  label53 = gtk_label_new (_("DPI"));
  gtk_widget_ref (label53);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "label53", label53,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label53);
  gtk_box_pack_start (GTK_BOX (hbox15), label53, FALSE, FALSE, 0);

  prefsimagecalibratebutton = gtk_button_new_with_label (_("  calibrate  "));
  gtk_widget_ref (prefsimagecalibratebutton);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "prefsimagecalibratebutton", prefsimagecalibratebutton,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (prefsimagecalibratebutton);
  gtk_box_pack_start (GTK_BOX (hbox14), prefsimagecalibratebutton, TRUE, FALSE, 0);

  prefsimageframe4 = gtk_frame_new (_("aspect-correction"));
  gtk_widget_ref (prefsimageframe4);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "prefsimageframe4", prefsimageframe4,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (prefsimageframe4);
  gtk_box_pack_start (GTK_BOX (vbox16), prefsimageframe4, FALSE, TRUE, 0);
  gtk_container_set_border_width (GTK_CONTAINER (prefsimageframe4), 5);
  gtk_frame_set_label_align (GTK_FRAME (prefsimageframe4), 0.5, 0.5);

  table7 = gtk_table_new (3, 2, FALSE);
  gtk_widget_ref (table7);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "table7", table7,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (table7);
  gtk_container_add (GTK_CONTAINER (prefsimageframe4), table7);
  gtk_container_set_border_width (GTK_CONTAINER (table7), 5);

  label39 = gtk_label_new (_("when not activated from the mainwindow this is the percentage\nof scaling above which the automatic aspect-correction occurs\n( I think a value of 100 should completely disable this feature :) )"));
  gtk_widget_ref (label39);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "label39", label39,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label39);
  gtk_table_attach (GTK_TABLE (table7), label39, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_label_set_justify (GTK_LABEL (label39), GTK_JUSTIFY_LEFT);
  gtk_misc_set_alignment (GTK_MISC (label39), 0, 0.5);

  spinbutton8_adj = gtk_adjustment_new (10, 0, 100, 1, 10, 10);
  spinbutton8 = gtk_spin_button_new (GTK_ADJUSTMENT (spinbutton8_adj), 1, 0);
  gtk_widget_ref (spinbutton8);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "spinbutton8", spinbutton8,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (spinbutton8);
  gtk_table_attach (GTK_TABLE (table7), spinbutton8, 1, 2, 0, 1,
                    (GtkAttachOptions) (0),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_spin_button_set_numeric (GTK_SPIN_BUTTON (spinbutton8), TRUE);

  label15 = gtk_label_new (_("rendering"));
  ...
  prefsimagelabel1 = gtk_label_new (_("if you don't activate background coloration explicitly, should the background color be guessed automatically? ( FIXME / it's getting better - help wanted!! )"));
  ...
  label36 = gtk_label_new (_("hide statusbar which displays image-details ? \n( when in fullscreen-mode )"));
  ...
  gtk_table_attach (GTK_TABLE (table2), prefsimagecheckbutton4, 1, 2, 7, 8,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (prefsimagecheckbutton4), TRUE);
  ...
  gtk_table_attach (GTK_TABLE (table6), prefsthumbradiobutton5, 0, 1, 3, 4,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table6), label28, 1, 2, 3, 4,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table6), prefsthumbentry2, 2, 3, 3, 4,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_table_attach (GTK_TABLE (table6), hseparator6, 0, 3, 2, 3,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), 0, 5);

  vbox17 = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (vbox17);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "vbox17", vbox17,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox17);
  gtk_table_attach (GTK_TABLE (table6), vbox17, 0, 3, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL), 0, 5);

  hbox12 = gtk_hbox_new (FALSE, 0);
  gtk_widget_ref (hbox12);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "hbox12", hbox12,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hbox12);
  gtk_box_pack_start (GTK_BOX (vbox17), hbox12, TRUE, TRUE, 0);

  label40 = gtk_label_new (_("current size allocated \nfor thumbnails in rc-dir"));
  gtk_widget_ref (label40);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "label40", label40,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label40);
  gtk_box_pack_start (GTK_BOX (hbox12), label40, TRUE, TRUE, 0);
  gtk_label_set_justify (GTK_LABEL (label40), GTK_JUSTIFY_FILL);

  prefsthumbentry3 = gtk_entry_new_with_max_length (30);
  gtk_widget_ref (prefsthumbentry3);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "prefsthumbentry3", prefsthumbentry3,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (prefsthumbentry3);
  gtk_box_pack_start (GTK_BOX (hbox12), prefsthumbentry3, TRUE, TRUE, 10);
  gtk_entry_set_editable (GTK_ENTRY (prefsthumbentry3), FALSE);
  gtk_entry_set_text (GTK_ENTRY (prefsthumbentry3), _("click this button ->"));

  prefsthumbupdatebutton = gtk_button_new_with_label (_("update\nresult"));
  gtk_widget_ref (prefsthumbupdatebutton);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "prefsthumbupdatebutton", prefsthumbupdatebutton,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (prefsthumbupdatebutton);
  gtk_box_pack_start (GTK_BOX (hbox12), prefsthumbupdatebutton, TRUE, TRUE, 0);
  gtk_widget_set_sensitive (prefsthumbupdatebutton, FALSE);

  prefsthumbclearbutton = gtk_button_new_with_label (_("delete\nthumbnails"));
  gtk_widget_ref (prefsthumbclearbutton);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "prefsthumbclearbutton", prefsthumbclearbutton,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (prefsthumbclearbutton);
  gtk_box_pack_start (GTK_BOX (hbox12), prefsthumbclearbutton, TRUE, TRUE, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "table8", table8,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (table8);
  gtk_container_add (GTK_CONTAINER (prefsmainnotebook), table8);
  gtk_container_set_border_width (GTK_CONTAINER (table8), 5);

  frame9 = gtk_frame_new (_("file-type filtering rules"));
  gtk_widget_ref (frame9);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "frame9", frame9,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (frame9);
  gtk_table_attach (GTK_TABLE (table8), frame9, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "table9", table9,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (table9);
  gtk_container_add (GTK_CONTAINER (frame9), table9);
  gtk_container_set_border_width (GTK_CONTAINER (table9), 5);

  label45 = gtk_label_new (_("don't show audio-files"));
  gtk_widget_ref (label45);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "label45", label45,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label45);
  gtk_table_attach (GTK_TABLE (table9), label45, 0, 1, 2, 3,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL),
                    (GtkAttachOptions) (GTK_SHRINK | GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label45), 0, 0.5);
  gtk_misc_set_padding (GTK_MISC (label45), 5, 0);

  label46 = gtk_label_new (_("don't show image-files"));
  gtk_widget_ref (label46);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "label46", label46,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label46);
  gtk_table_attach (GTK_TABLE (table9), label46, 0, 1, 3, 4,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL),
                    (GtkAttachOptions) (GTK_SHRINK | GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label46), 0, 0.5);
  gtk_misc_set_padding (GTK_MISC (label46), 5, 0);

  label47 = gtk_label_new (_("don't show movie-files"));
  gtk_widget_ref (label47);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "label47", label47,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label47);
  gtk_table_attach (GTK_TABLE (table9), label47, 0, 1, 4, 5,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL),
                    (GtkAttachOptions) (GTK_SHRINK | GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label47), 0, 0.5);
  gtk_misc_set_padding (GTK_MISC (label47), 5, 0);

  label43 = gtk_label_new (_("don't show leading-dot files? (hidden files)"));
  gtk_widget_ref (label43);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "label43", label43,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label43);
  gtk_table_attach (GTK_TABLE (table9), label43, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL),
                    (GtkAttachOptions) (GTK_SHRINK | GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label43), 0, 0.5);
  gtk_misc_set_padding (GTK_MISC (label43), 5, 0);

  label44 = gtk_label_new (_("hide non multimedia content (apps, text-files etc.)"));
  gtk_widget_ref (label44);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "label44", label44,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label44);
  gtk_table_attach (GTK_TABLE (table9), label44, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL),
                    (GtkAttachOptions) (GTK_SHRINK | GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label44), 0, 0.5);
  gtk_misc_set_padding (GTK_MISC (label44), 5, 0);

  prefsfiltercheckbutton2 = gtk_check_button_new_with_label ("");
  gtk_widget_ref (prefsfiltercheckbutton2);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "prefsfiltercheckbutton2", prefsfiltercheckbutton2,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (prefsfiltercheckbutton2);
  gtk_table_attach (GTK_TABLE (table9), prefsfiltercheckbutton2, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_SHRINK),
                    (GtkAttachOptions) (GTK_SHRINK), 0, 0);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (prefsfiltercheckbutton2), TRUE);

  prefsfiltercheckbutton3 = gtk_check_button_new_with_label ("");
  gtk_widget_ref (prefsfiltercheckbutton3);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "prefsfiltercheckbutton3", prefsfiltercheckbutton3,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (prefsfiltercheckbutton3);
  gtk_table_attach (GTK_TABLE (table9), prefsfiltercheckbutton3, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_SHRINK),
                    (GtkAttachOptions) (GTK_SHRINK), 0, 0);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (prefsfiltercheckbutton3), TRUE);

  prefsfiltercheckbutton4 = gtk_check_button_new_with_label ("");
  gtk_widget_ref (prefsfiltercheckbutton4);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "prefsfiltercheckbutton4", prefsfiltercheckbutton4,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (prefsfiltercheckbutton4);
  gtk_table_attach (GTK_TABLE (table9), prefsfiltercheckbutton4, 1, 2, 2, 3,
                    (GtkAttachOptions) (GTK_SHRINK),
                    (GtkAttachOptions) (GTK_SHRINK), 0, 0);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (prefsfiltercheckbutton4), TRUE);

  prefsfiltercheckbutton5 = gtk_check_button_new_with_label ("");
  gtk_widget_ref (prefsfiltercheckbutton5);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "prefsfiltercheckbutton5", prefsfiltercheckbutton5,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (prefsfiltercheckbutton5);
  gtk_table_attach (GTK_TABLE (table9), prefsfiltercheckbutton5, 1, 2, 3, 4,
                    (GtkAttachOptions) (GTK_SHRINK),
                    (GtkAttachOptions) (GTK_SHRINK), 0, 0);

  prefsfiltercheckbutton6 = gtk_check_button_new_with_label ("");
  gtk_widget_ref (prefsfiltercheckbutton6);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "prefsfiltercheckbutton6", prefsfiltercheckbutton6,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (prefsfiltercheckbutton6);
  gtk_table_attach (GTK_TABLE (table9), prefsfiltercheckbutton6, 1, 2, 4, 5,
                    (GtkAttachOptions) (GTK_SHRINK),
                    (GtkAttachOptions) (GTK_SHRINK), 0, 0);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (prefsfiltercheckbutton6), TRUE);

  table10 = gtk_table_new (1, 2, FALSE);
  gtk_widget_ref (table10);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "table10", table10,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (table10);
  gtk_table_attach (GTK_TABLE (table8), table10, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_EXPAND),
                    (GtkAttachOptions) (0), 0, 42);

  prefsfiltercheckbutton1 = gtk_check_button_new_with_label ("");
  gtk_widget_ref (prefsfiltercheckbutton1);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "prefsfiltercheckbutton1", prefsfiltercheckbutton1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (prefsfiltercheckbutton1);
  gtk_table_attach (GTK_TABLE (table10), prefsfiltercheckbutton1, 1, 2, 0, 1,
                    (GtkAttachOptions) (0),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (prefsfiltercheckbutton1), TRUE);

  label42 = gtk_label_new (_("enable file-type filtering?\n( you have to reload the current dir\n in order to see a difference ! )"));
  gtk_widget_ref (label42);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "label42", label42,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label42);
  gtk_table_attach (GTK_TABLE (table10), label42, 0, 1, 0, 1,
                    (GtkAttachOptions) (0),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label42), 0, 0.5);
  gtk_misc_set_padding (GTK_MISC (label42), 28, 0);

  prefslabel4 = gtk_label_new (_("file-filter"));
  gtk_widget_ref (prefslabel4);
  gtk_object_set_data_full (GTK_OBJECT (prefswindow), "prefslabel4", prefslabel4,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (prefslabel4);
  gtk_notebook_set_tab_label (GTK_NOTEBOOK (prefsmainnotebook), gtk_notebook_get_nth_page (GTK_NOTEBOOK (prefsmainnotebook), 3), prefslabel4);
  ...
  gtk_signal_connect (GTK_OBJECT (prefsmainentry2), "activate",
                      ...
                      NULL);
  gtk_signal_connect (GTK_OBJECT (prefsmainloadbutton), "clicked",
                      GTK_SIGNAL_FUNC (on_prefsmainloadbutton_clicked),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (prefsmainsavebutton), "clicked",
                      GTK_SIGNAL_FUNC (on_prefsmainsavebutton_clicked),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (prefsmainreset), "clicked",
                      GTK_SIGNAL_FUNC (on_prefsmainreset_clicked),
                      NULL);
  ...
  gtk_signal_connect (GTK_OBJECT (prefsimageradiobutton4), "toggled",
                      ...
                      NULL);
  gtk_signal_connect (GTK_OBJECT (prefsimagecalibratebutton), "clicked",
                      GTK_SIGNAL_FUNC (on_prefsimagecalibratebutton_clicked),
                      NULL);
  ...
  gtk_signal_connect (GTK_OBJECT (prefsthumbentry2), "activate",
                      ...
                      NULL);
  gtk_signal_connect (GTK_OBJECT (prefsthumbupdatebutton), "clicked",
                      GTK_SIGNAL_FUNC (on_prefsthumbupdatebutton_clicked),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (prefsthumbclearbutton), "clicked",
                      GTK_SIGNAL_FUNC (on_prefsthumbclearbutton_clicked),
                      NULL);
...
create_fullscreenwindow (void)
{
  ...
  gtk_widget_set_events (fullscreenwindow, GDK_POINTER_MOTION_MASK);
  gtk_window_set_title (GTK_WINDOW (fullscreenwindow), _("Look at the stars in fullscreen-mode"));
  gtk_window_set_default_size (GTK_WINDOW (fullscreenwindow), 640, 480);
  gtk_window_set_policy (GTK_WINDOW (fullscreenwindow), TRUE, TRUE, TRUE);

  packer3 = gtk_packer_new ();
  gtk_widget_ref (packer3);
  gtk_object_set_data_full (GTK_OBJECT (fullscreenwindow), "packer3", packer3,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (packer3);
  gtk_container_add (GTK_CONTAINER (fullscreenwindow), packer3);
  ...
  gtk_object_set_data_full (GTK_OBJECT (fullscreenwindow), "scrolledwindow6", scrolledwindow6,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (scrolledwindow6);
  gtk_packer_add_defaults (GTK_PACKER (packer3), scrolledwindow6, GTK_SIDE_TOP,
                           GTK_ANCHOR_CENTER, (GtkPackerOptions) (GTK_PACK_EXPAND | GTK_FILL_X | GTK_FILL_Y));
  gtk_scrolled_window_set_policy (GTK_SCROLLED_WINDOW (scrolledwindow6), GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
  ...
  gtk_widget_show (viewport1);
  gtk_container_add (GTK_CONTAINER (scrolledwindow6), viewport1);
  gtk_widget_set_events (viewport1, GDK_POINTER_MOTION_MASK | GDK_BUTTON_MOTION_MASK | GDK_BUTTON_PRESS_MASK | GDK_BUTTON_RELEASE_MASK);
  gtk_widget_set_extension_events (viewport1, GDK_EXTENSION_EVENTS_ALL);
  ...
  gtk_signal_connect (GTK_OBJECT (scrolledwindow6), "size_allocate",
                      ...
                      fullscreenwindow);
  gtk_signal_connect (GTK_OBJECT (scrolledwindow6), "button_press_event",
                      GTK_SIGNAL_FUNC (on_fullscreenwindow_button_press_event),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (scrolledwindow6), "button_release_event",
                      GTK_SIGNAL_FUNC (on_fullscreenwindow_button_release_event),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (scrolledwindow6), "motion_notify_event",
                      GTK_SIGNAL_FUNC (on_fullscreenwindow_motion_notify_event),
                      NULL);
...
create_shutdownwindow (void)
{
  ...
  label38 = gtk_label_new (_("shutdown in progress..."));
...
GtkWidget*
create_fullscreenwindowprogressbar (void)
{
  ...
  fullscreenwindowprogressbar = gtk_window_new (GTK_WINDOW_POPUP);
  gtk_object_set_data (GTK_OBJECT (fullscreenwindowprogressbar), "fullscreenwindowprogressbar", fullscreenwindowprogressbar);
  gtk_window_set_title (GTK_WINDOW (fullscreenwindowprogressbar), _("Look at the stars fullscreen-progressbar"));

  appbarbox = gtk_hbox_new (FALSE, 0);
  gtk_widget_ref (appbarbox);
  gtk_object_set_data_full (GTK_OBJECT (fullscreenwindowprogressbar), "appbarbox", appbarbox,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (appbarbox);
  gtk_container_add (GTK_CONTAINER (fullscreenwindowprogressbar), appbarbox);

  appbar2 = gnome_appbar_new (TRUE, TRUE, GNOME_PREFERENCES_NEVER);
  gtk_widget_ref (appbar2);
  gtk_object_set_data_full (GTK_OBJECT (fullscreenwindowprogressbar), "appbar2", appbar2,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (appbar2);
  gtk_box_pack_start (GTK_BOX (appbarbox), appbar2, TRUE, TRUE, 0);
  ...
  progressbar1 = gtk_progress_bar_new ();
  gtk_widget_ref (progressbar1);
  gtk_object_set_data_full (GTK_OBJECT (fullscreenwindowprogressbar), "progressbar1", progressbar1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (progressbar1);
  gtk_box_pack_start (GTK_BOX (appbarbox), progressbar1, FALSE, FALSE, 0);
  gtk_progress_configure (GTK_PROGRESS (progressbar1), 0, 0, 0);
  ...
  return fullscreenwindowprogressbar;
}

GtkWidget*
create_calibratewindow (void)
{
  ...
  GtkObject *spinbuttonvert_adj;
  GtkWidget *spinbuttonvert;
  GtkObject *spinbuttonhoriz_adj;
  GtkWidget *spinbuttonhoriz;
  GtkWidget *label56;
  GtkWidget *label55;
  GtkWidget *label54;
  GtkWidget *vbox19;
  GtkWidget *label57;
  GSList *inches_or_millimeters_group = NULL;
  GtkWidget *radiobuttoninch;
  GtkWidget *radiobuttonmm;
  GtkWidget *hruler1;
  GtkWidget *vruler1;
  GtkWidget *dialog_action_area1;
  GtkWidget *calibrate_okbutton;
  GtkWidget *calibrate_cancelbutton;

  calibratewindow = gnome_dialog_new (_("Calibrate..."), NULL);
  gtk_object_set_data (GTK_OBJECT (calibratewindow), "calibratewindow", calibratewindow);
  GTK_WINDOW (calibratewindow)->type = GTK_WINDOW_DIALOG;
  gtk_window_set_position (GTK_WINDOW (calibratewindow), GTK_WIN_POS_CENTER);
  gtk_window_set_policy (GTK_WINDOW (calibratewindow), TRUE, FALSE, TRUE);
  gnome_dialog_set_close (GNOME_DIALOG (calibratewindow), TRUE);
  gnome_dialog_close_hides (GNOME_DIALOG (calibratewindow), TRUE);

  dialog_vbox1 = GNOME_DIALOG (calibratewindow)->vbox;
  gtk_object_set_data (GTK_OBJECT (calibratewindow), "dialog_vbox1", dialog_vbox1);
  gtk_widget_show (dialog_vbox1);

  table12 = gtk_table_new (2, 2, FALSE);
  gtk_widget_ref (table12);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "table12", table12,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (table12);
  gtk_box_pack_start (GTK_BOX (dialog_vbox1), table12, TRUE, TRUE, 0);

  packer4 = gtk_packer_new ();
  gtk_widget_ref (packer4);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "packer4", packer4,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (packer4);
  gtk_table_attach (GTK_TABLE (table12), packer4, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_FILL), 0, 0);

  alignment1 = gtk_alignment_new (0.5, 0.5, 1, 1);
  gtk_widget_ref (alignment1);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "alignment1", alignment1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (alignment1);
  gtk_packer_add_defaults (GTK_PACKER (packer4), alignment1, GTK_SIDE_TOP,
                           GTK_ANCHOR_CENTER, (GtkPackerOptions) (GTK_PACK_EXPAND));

  table13 = gtk_table_new (3, 4, FALSE);
  gtk_widget_ref (table13);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "table13", table13,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (table13);
  gtk_container_add (GTK_CONTAINER (alignment1), table13);

  vseparator5 = gtk_vseparator_new ();
  gtk_widget_ref (vseparator5);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "vseparator5", vseparator5,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vseparator5);
  gtk_table_attach (GTK_TABLE (table13), vseparator5, 2, 3, 1, 3,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL), 0, 0);

  spinbuttonvert_adj = gtk_adjustment_new (111, 0, 1000, 1, 10, 10);
  spinbuttonvert = gtk_spin_button_new (GTK_ADJUSTMENT (spinbuttonvert_adj), 1, 3);
  gtk_widget_ref (spinbuttonvert);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "spinbuttonvert", spinbuttonvert,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (spinbuttonvert);
  gtk_table_attach (GTK_TABLE (table13), spinbuttonvert, 1, 2, 2, 3,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL), 0, 0);
  gtk_spin_button_set_numeric (GTK_SPIN_BUTTON (spinbuttonvert), TRUE);

  spinbuttonhoriz_adj = gtk_adjustment_new (139, 0, 1000, 1, 10, 10);
  spinbuttonhoriz = gtk_spin_button_new (GTK_ADJUSTMENT (spinbuttonhoriz_adj), 1, 3);
  gtk_widget_ref (spinbuttonhoriz);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "spinbuttonhoriz", spinbuttonhoriz,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (spinbuttonhoriz);
  gtk_table_attach (GTK_TABLE (table13), spinbuttonhoriz, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL), 0, 0);
  gtk_spin_button_set_numeric (GTK_SPIN_BUTTON (spinbuttonhoriz), TRUE);

  label56 = gtk_label_new (_("vertical"));
  gtk_widget_ref (label56);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "label56", label56,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label56);
  gtk_table_attach (GTK_TABLE (table13), label56, 0, 1, 2, 3,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label56), 0, 0.5);

  label55 = gtk_label_new (_("horizontal"));
  gtk_widget_ref (label55);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "label55", label55,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label55);
  gtk_table_attach (GTK_TABLE (table13), label55, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label55), 0, 0.5);

  label54 = gtk_label_new (_("please measure the rulers and enter their lengths below..."));
  gtk_widget_ref (label54);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "label54", label54,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label54);
  gtk_table_attach (GTK_TABLE (table13), label54, 0, 4, 0, 1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL), 0, 20);
  gtk_misc_set_alignment (GTK_MISC (label54), 0, 0.5);

  vbox19 = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (vbox19);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "vbox19", vbox19,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox19);
  gtk_table_attach (GTK_TABLE (table13), vbox19, 3, 4, 1, 3,
                    (GtkAttachOptions) (GTK_SHRINK | GTK_FILL),
                    (GtkAttachOptions) (GTK_SHRINK | GTK_FILL), 0, 0);

  label57 = gtk_label_new (_("entered as..."));
  gtk_widget_ref (label57);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "label57", label57,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label57);
  gtk_box_pack_start (GTK_BOX (vbox19), label57, TRUE, TRUE, 0);

  radiobuttoninch = gtk_radio_button_new_with_label (inches_or_millimeters_group, _("inches"));
  inches_or_millimeters_group = gtk_radio_button_group (GTK_RADIO_BUTTON (radiobuttoninch));
  gtk_widget_ref (radiobuttoninch);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "radiobuttoninch", radiobuttoninch,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (radiobuttoninch);
  gtk_box_pack_start (GTK_BOX (vbox19), radiobuttoninch, TRUE, TRUE, 0);

  radiobuttonmm = gtk_radio_button_new_with_label (inches_or_millimeters_group, _("millimeters"));
  inches_or_millimeters_group = gtk_radio_button_group (GTK_RADIO_BUTTON (radiobuttonmm));
  gtk_widget_ref (radiobuttonmm);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "radiobuttonmm", radiobuttonmm,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (radiobuttonmm);
  gtk_box_pack_start (GTK_BOX (vbox19), radiobuttonmm, TRUE, TRUE, 0);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (radiobuttonmm), TRUE);

  hruler1 = gtk_hruler_new ();
  gtk_widget_ref (hruler1);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "hruler1", hruler1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hruler1);
  gtk_table_attach (GTK_TABLE (table12), hruler1, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL), 5, 0);
  gtk_widget_set_usize (hruler1, 500, 36);
  gtk_ruler_set_range (GTK_RULER (hruler1), 0, 500, 0, 500);

  vruler1 = gtk_vruler_new ();
  gtk_widget_ref (vruler1);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "vruler1", vruler1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vruler1);
  gtk_table_attach (GTK_TABLE (table12), vruler1, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_SHRINK | GTK_FILL),
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), 5, 5);
  gtk_widget_set_usize (vruler1, 36, 400);
  gtk_ruler_set_range (GTK_RULER (vruler1), 0, 400, 0, 400);

  dialog_action_area1 = GNOME_DIALOG (calibratewindow)->action_area;
  gtk_object_set_data (GTK_OBJECT (calibratewindow), "dialog_action_area1", dialog_action_area1);
  gtk_widget_show (dialog_action_area1);
  gtk_button_box_set_layout (GTK_BUTTON_BOX (dialog_action_area1), GTK_BUTTONBOX_SPREAD);
  gtk_button_box_set_spacing (GTK_BUTTON_BOX (dialog_action_area1), 8);

  gnome_dialog_append_button (GNOME_DIALOG (calibratewindow), GNOME_STOCK_BUTTON_OK);
  calibrate_okbutton = GTK_WIDGET (g_list_last (GNOME_DIALOG (calibratewindow)->buttons)->data);
  gtk_widget_ref (calibrate_okbutton);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "calibrate_okbutton", calibrate_okbutton,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (calibrate_okbutton);
  GTK_WIDGET_SET_FLAGS (calibrate_okbutton, GTK_CAN_DEFAULT);

  gnome_dialog_append_button (GNOME_DIALOG (calibratewindow), GNOME_STOCK_BUTTON_CANCEL);
  calibrate_cancelbutton = GTK_WIDGET (g_list_last (GNOME_DIALOG (calibratewindow)->buttons)->data);
  gtk_widget_ref (calibrate_cancelbutton);
  gtk_object_set_data_full (GTK_OBJECT (calibratewindow), "calibrate_cancelbutton", calibrate_cancelbutton,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (calibrate_cancelbutton);
  GTK_WIDGET_SET_FLAGS (calibrate_cancelbutton, GTK_CAN_DEFAULT);

  gtk_signal_connect_object (GTK_OBJECT (calibratewindow), "delete_event",
                             GTK_SIGNAL_FUNC (gtk_widget_hide),
                             GTK_OBJECT (calibratewindow));
  gtk_signal_connect_object (GTK_OBJECT (calibratewindow), "destroy_event",
                             GTK_SIGNAL_FUNC (gtk_widget_hide),
                             GTK_OBJECT (calibratewindow));
  gtk_signal_connect (GTK_OBJECT (calibratewindow), "show",
                      GTK_SIGNAL_FUNC (on_calibratewindow_show),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (radiobuttoninch), "toggled",
                      GTK_SIGNAL_FUNC (on_radiobuttoninch_toggled),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (radiobuttonmm), "toggled",
                      GTK_SIGNAL_FUNC (on_radiobuttonmm_toggled),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (calibrate_okbutton), "clicked",
                      GTK_SIGNAL_FUNC (on_calibrate_okbutton_clicked),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (calibrate_cancelbutton), "clicked",
                      GTK_SIGNAL_FUNC (on_calibrate_cancelbutton_clicked),
                      NULL);
